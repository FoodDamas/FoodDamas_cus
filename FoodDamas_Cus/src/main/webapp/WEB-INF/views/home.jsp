...
.nav-dropdown li a {
 ...
 -->
      ...
      <div class="slider-container popular_restaurant_container" id="graCont" style=" display:none">
         <ul class="list-restaurants type-main" id="gradeList">
         </ul>
         <button class="more_btn" id="graMore">더보기</button>
      </div>
      
      <div class="slider-container popular_restaurant_container" id="revCont" style=" display:none">
         <ul class="list-restaurants type-main" id="reviewList">
         </ul>
         <button class="more_btn" id="revMore">더보기</button>
      </div>
      
      <div class="slider-container popular_restaurant_container" id="menCont" style=" display:none">
